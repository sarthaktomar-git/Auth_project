                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="#" class="noble-ui-logo d-block mb-2">Reset<span>Password</span></a>
                                        ...
                                        <form class="forms-sample needs-validation" action="" method="post">
                                            ...
                                            <div>
                                                <button
                                                    class="btn btn-primary me-2 mb-2 mb-md-0 text-white">Reset</button>
                                            </div>
                                            <a href="{{ url('login') }}" class="d-block mt-3 text-muted">login</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
