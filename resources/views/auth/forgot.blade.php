                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="#" class="noble-ui-logo d-block mb-2">Forgot<span>Password</span></a>
                                        <p>Enter your email to forgot password</p>
                                        <h5 class="text-muted fw-normal mb-4"> </h5>
                                        @include('layouts._message')
                                        <form class="forms-sample needs-validation" action="" method="post">
                                            {{ csrf_field() }}
                                            <div class="mb-3">
                                            ...
                                            <div>
                                                ...
                                                <button
                                                    class="btn btn-primary me-2 mb-2 mb-md-0 text-white">Forgot</button>

                                            </div>
                                            <a href="{{ url('register') }}" class="d-block mt-3 text-muted">Create an
                                                account</a>
                                        </form>
                                    </div>
                                </div>
