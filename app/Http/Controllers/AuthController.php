...
class AuthController extends Controller
{
    ...
    //     else
    //     {
    //         return redirect()->back()->with('error', "Please enter correct email and passsword");
    //     }
    ...
    public function create_user(Request $request)
    {
        ...
        return redirect('login')->with('success', "Your account registered successfully. Please verify your email address");
    }
